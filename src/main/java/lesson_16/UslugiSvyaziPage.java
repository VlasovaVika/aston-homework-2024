...
public class UslugiSvyaziPage {
    ...
    private String mastercargLogo = "//div[contains(@class, 'cards-brands')]/img[contains(@src, 'mastercard')]";
    private String visaLogo = "//div[contains(@class, 'cards-brands')]/img[contains(@src, 'visa')]";
    private String belcardLogo = "//div[contains(@class, 'cards-brands')]/img[contains(@src, 'belkart')]";
